...
function Shop() {
  ...
  //1. load products default on page load
  ...
  //2. load products in user search input
  useEffect(() => {
  ...
  //show category list of checkbox
    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-9 pt-2">
          {loading ? <Loader /> : <h4 className="text-danger">Products</h4>}
